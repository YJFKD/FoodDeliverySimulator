...
def write_json_to_file_append(file_name, data):
...
def get_output_of_algorithm(id_to_order: dict):
    ...
    driver_id_to_entire_planned_route_from_json = read_json_from_file(Configs.algorithm_output_entire_planned_route_path)
    driver_id_to_entire_planned_route = __convert_json_to_nodes(driver_id_to_entire_planned_route_from_json, id_to_order)
