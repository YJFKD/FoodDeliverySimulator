class DispatchResult(object):
    ...
    """
    def __init__(self, driver_id_to_destination: dict, driver_id_to_planned_route: dict, driver_id_to_entire_planned_route: dict):
        """
        ...
        # Have to return the entire planned route of each driver. Include the driver current location
        self.driver_id_to_entire_planned_route = driver_id_to_entire_planned_route